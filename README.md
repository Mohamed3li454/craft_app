...
A modern, high-performance Flutter application engineered for fluid conversational AI, multimodal vision queries, real-time typewriter response streaming, chat history archiving, and offline resilience. Built with Google Gemini 1.5 Flash, full dark theme aesthetics, and a robust Feature-First Cubit architecture.
...
[![AI Engine](https://img.shields.io/badge/AI%20Engine-Google%20Gemini%201.5-8E75FF?style=for-the-badge&logo=google&logoColor=white)](https://ai.google.dev)
...
Whether you need academic homework assistance, health habits coaching, communication skills guidance, or image analysis, Craft leverages **Gemini 1.5 Flash** for rapid, accurate, and context-aware responses formatted in rich GitHub-flavored Markdown.
...
- **🧠 Google Gemini 1.5 Flash Integration**: Real-time generative AI responses for both text queries and vision queries using the official `google_generative_ai` SDK with full conversational history context.
...
| **AI Engine** | `google_generative_ai` | Official Google Gemini SDK (`gemini-1.5-flash`) |
...
```
        ...
        │  • Model: gemini-1.5-flash      │   │  • getOldChats()          │
        └────────────────┬────────────────┘   │  • saveOldChats()         │
                         │                    └───────────────────────────┘
                         ▼
        ┌─────────────────────────────────────────────────────────────────┐
